...
prod_data_path = f"/mnt/edl/raw/scf_cq_hub/m6_prod_data"
...
mlflow.set_experiment(f"/Users/PachecoFilipe@JohnDeere.com/LLM 06 - MLflow experiment")
...
inference_results_path = f"/mnt/edl/raw/scf_cq_hub/m6-inference-results".replace(
    "/dbfs", "dbfs:"
)
