...
os.environ["SERPAPI_API_KEY"] = "XXXXXXXXXXXXXXXXXXX"
...
datasci_data_df = pd.read_csv(f'file:{os.path.dirname(os.getcwd())}/Datasets/ds_salaries.csv')
# world_data
dascie = create_pandas_dataframe_agent(
    llm,#OpenAI(temperature=0)
    datasci_data_df, verbose=True
)
