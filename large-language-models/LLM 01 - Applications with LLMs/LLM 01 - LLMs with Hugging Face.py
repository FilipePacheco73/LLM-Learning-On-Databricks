...
summarizer = pipeline(
    task="summarization", # What is gonna be the task of the model, in this case,summarization
    model="t5-small", # Here is passed the model choosed
    min_length=20, # Optional, output min size
    max_length=40, # Optional, output max size
    truncation=True,
...
t5_small_pipeline(
    ...
    "translate English to French: Everyday is a new day."]
)
